...
- `generated-check.js` also rejects raw control characters in generated Markdown, catching under-escaped LaTeX commands before deployment.
...
- `.editorconfig` standardizes UTF-8, LF line endings, final newline, and indentation before `repo-hygiene.js` enforces them.
